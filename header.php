            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.php">
                  ...
                  <div style="width:550px; ">&nbsp;<strong>Flash</strong> <strong> News </strong> <strong>Today</strong> </div>
                </a>
                <!--  img based logo -->
...
{
?> 
<ul class="nav navbar-nav btn " style="background-color: limegreen;">
              <li STYLE="padding: 10px 15px;background-color: green; color:white;">EMPLOYEE MENU >></li>			  
...
?>
<ul class="nav navbar-nav btn " style="background-color:limegreen;">
              <li STYLE="padding: 10px 15px;background-color: green; color:white;">ADVERTISER MENU >></li>			  
